<%-- 
    Document   : adminstaff
    Created on : May 14, 2023, 1:54:57 AM
    Author     : Lenovo
--%>
...
<jsp:include page="AdminGetAllStaff"/>
<%
    UserDto user = null;
    ...
    {
        staffs = (List<UserDto>) session.getAttribute("staffs");
    }
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid bg-dark" style="height: 180px; z-index: 0; position: absolute;">
            <p class="text-white fs-5 fw-bold mt-4 text-center">Admin Management</p>
        </div>
            ...
            <div class="accordion" id="accordionExample" style="background-color: white;">
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <form method="post" action="AdminAddStaff">
...
<!--                                <div class="form-floating mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="contact" placeholder="Contact" name="ctc"/>
                                    <label for="contact">Contact</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="date" class="form-control" id="dob" placeholder="Date of Birth" name="db"/>
            ...
            <table class="table table-striped text-center"  style="background-color: white;">
                ...
                <tbody>
                    <%
                        if(!staffs.isEmpty()){
                            int i = 1;
                            for(UserDto s : staffs){
                    %>
                    <tr>
                        <th scope="row"><%=i%></th>
                        <td><%=s.getUsername() %></td>
                        <td><%=s.getFullname() %></td>
                        <form method="post" action="adminviewuser.jsp?select=Admin&userid=<%=s.getUserid() %>">
                        ...
                        <form method="post" action="adminupdateuser.jsp?select=Admin&userid=<%=s.getUserid() %>">
                            <input type="hidden" name="userid" value="<%=s.getUserid() %>"/>
                    ...
                    <tr>
                        <td colspan="5">
                            <strong>No staff found.</strong> Please try a different search criteria.
                        </td>
                    </tr>
                    <%  } %>
                </tbody>
