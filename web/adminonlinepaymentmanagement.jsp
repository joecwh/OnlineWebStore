<%-- 
    Document   : adminonlinepaymentmanagement
    Created on : Jul 11, 2023, 3:36:21 PM
    Author     : Lenovo
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid bg-dark" style="height: 180px; z-index: 0; position: absolute;">
            <p class="text-white fs-5 fw-bold mt-4 text-center">Online Payment Management</p>
        </div>
            ...
            <div class="accordion" id="accordionExample" style="background-color: white;">
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <form method="post" action="AdminAddPayment"
                              >
                            <div class="accordion-body">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="bannername" placeholder="Bank Name" name="bankname" required>
                ...
                <tbody>
                    <%
                        if(!onlinebanking.isEmpty()){
                            int i = 1;
                            for(PaymentMethod b : onlinebanking){
                    %>
                    <tr>
                        <th scope="row"><%=i%></th>
                        <td><%=b.getName()%></td>
                        <form method="post" action="AdminDeletePayment?bankid=<%=b.getPaymentid() %>" id="deletebanner">
                    ...
                    <tr>
                        <td colspan="5">
                            <strong>No online payment found.</strong> Please try a different search criteria.
                        </td>
                    </tr>
                    <%  } %>
                </tbody>
