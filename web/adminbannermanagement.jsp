<%-- 
    Document   : adminbanner
    Created on : May 14, 2023, 1:55:33 AM
    Author     : Lenovo
--%>
...
<jsp:include page="GetAllBannerServlet"/>
<%
    UserDto user = null;
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid bg-dark" style="height: 180px; z-index: 0; position: absolute;">
            <p class="text-white fs-5 fw-bold mt-4 text-center">Homepage's Banner Management</p>
        </div>
        ...
        <div class="container" style="margin-top: 100px; position: relative; min-height: 530px;">
            <div class="accordion" id="accordionExample" style="background-color: white;">
                <div class="accordion-item">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <form method="post" action="AddBannerServlet" enctype="multipart/form-data">
                            <div class="accordion-body">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="bannername" placeholder="Banner Name" name="bannername" required>
                                    <label for="bannername">Banner Name</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="bannerdesc" placeholder="Banner Description" name="bannerdesc" required>
                                    <label for="bannerdesc">Banner Description</label>
                                </div>
                                <div class="mb-3">
                                    <input class="form-control" type="file" id="formFile" name="bannerimg" required>
                                </div>
            ...
            <table class="table table-striped text-center"  style="background-color: white;">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row"><%=i%></th>
                        <td><%=b.getBannername() %></td>
                        <form method="post" action="adminviewbanner.jsp?bannerid=<%=b.getBannerid() %>">
                            <input type="hidden" name="bannerid" value="<%=b.getBannerid() %>"/>
                        ...
                        <form method="post" action="adminupdatebanner.jsp?bannerid=<%=b.getBannerid() %>">
                            <input type="hidden" name="bannerid" value="<%=b.getBannerid() %>"/>
                        ...
                        <form method="post" action="AdminDeleteBanner" id="deletebanner">
                            <input type="hidden" name="bannerid" value="<%=b.getBannerid() %>"/>
                    ...
                    <tr>
                        <td colspan="5">
                            <strong>No banner found.</strong> Please try a different search criteria.
                        </td>
                    </tr>
                    <%  } %>
                </tbody>
