...
public class AdminUpdateStaff extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  
        {
            ...
            Result<Users> currectUser = _adminRepository.GetStaff(userid);
            Users newUser = new Users(userid, username, fullname, email, contact, date, accountstatus);
            newUser.setPassword(currectUser.getResult().getPassword());
            newUser.setCreatedat(currectUser.getResult().getCreatedat());
            newUser.setLastlogin(currectUser.getResult().getLastlogin());
